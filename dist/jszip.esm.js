...
function string2binary(str) {
    var result = new Uint8Array(str.length);    return stringToArrayLike(str, result);
}
...
const utf8decode = function utf8decode(buf) {
    buf = transformTo("uint8array", buf);
...
Utf8DecodeWorker.prototype.processChunk = function (chunk) {
    ...
    var data = transformTo("uint8array", chunk.data);
...
inherits(ArrayReader, DataReader);
/**
...
inherits(Uint8ArrayReader, ArrayReader);
/**
 * @see DataReader.readData
 */
...
inherits(DataWorker, GenericWorker);
...
inherits(DataLengthProbe, GenericWorker);
...
inherits(Crc32Probe, GenericWorker);
...
const compressWorker = function (compressionOptions) {
    return new FlateWorker("Deflate", compressionOptions);
};

const uncompressWorker = function () {
...
ZipEntry.prototype = {
     ...
     */
    handleUTF8: function() {
        var decodeParamType = "uint8array";
        if (this.useUTF8()) {
...
function loadAsync(data, options) {
    var zip = this;
...
for(var i$1 = 0; i$1 < removedMethods.length; i$1++) {
    ZipObject.prototype[removedMethods[i$1]] = removedFn;
}
...
inherits(ZipFileWorker, GenericWorker);
...
var fileAdd = function(name, data, originalOptions) {
    ...
    return Promise.resolve(zipObjectContent)
    .then(function () {
        return object;
    });
    */
