 ...
 */
export const newBlob = function(part, type) {
    checkSupport("blob");
 ...
 */
export const transformTo = function(outputType, input) {
    if (!input) {
        // undefined, null, etc
 ...
 */
export const getTypeOf = function(input) {
 ...
 */
export const checkSupport = function(type) {
 ...
 */
export const pretty = function(str) {
    var res = '',
        code, i;
 ...
 */
export const delay = function(callback, args, self) {
 ...
 */
export const prepareContent = function(name, inputData, isBinary, isOptimizedBinaryString, isBase64) {
